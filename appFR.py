...
def index():
    ...
    stats = {
        ...
        'rev_table' : df2.groupby(['Category','App'])[['Reviews','Rating']].sum().sort_values('Reviews', ascending = False).head(10).reset_index().to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
    ...
    ## Buatlah sebuah plot yang menampilkan insight di dalam data - jangan lupa diisi ini baru contoh
